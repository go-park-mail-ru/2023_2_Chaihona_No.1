...
var file_posts_proto_rawDesc = []byte{
	...
	0x32, 0xab, 0x05, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
...
var file_posts_proto_depIdxs = []int32{
	...
	2,  // 16: posts.PostsService.CreateCommentCtx:input_type -> posts.CommentGRPC
	7,  // 17: posts.PostsService.DeleteCommentCtx:input_type -> posts.UInt
	2,  // 18: posts.PostsService.ChangeCommentCtx:input_type -> posts.CommentGRPC
	8,  // 19: posts.PostsService.CreateNewPostCtx:output_type -> posts.Int
	10, // 20: posts.PostsService.DeletePostCtx:output_type -> posts.Nothing
	10, // 21: posts.PostsService.ChangePostCtx:output_type -> posts.Nothing
	5,  // 22: posts.PostsService.GetPostByIdCtx:output_type -> posts.PostGRPC
	6,  // 23: posts.PostsService.GetPostsByAuthorIdForStrangerCtx:output_type -> posts.PostsMapGRPC
	6,  // 24: posts.PostsService.GetOwnPostsByAuthorIdCtx:output_type -> posts.PostsMapGRPC
	6,  // 25: posts.PostsService.GetPostsByAuthorIdForFollowerCtx:output_type -> posts.PostsMapGRPC
	6,  // 26: posts.PostsService.GetUsersFeedCtx:output_type -> posts.PostsMapGRPC
	8,  // 27: posts.PostsService.CreateCommentCtx:output_type -> posts.Int
	10, // 28: posts.PostsService.DeleteCommentCtx:output_type -> posts.Nothing
	10, // 29: posts.PostsService.ChangeCommentCtx:output_type -> posts.Nothing
