...
func (m *MockPostRepository) CreateNewPost(post model.Post) *model.ErrorPost {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateNewPost", post)
	ret0, _ := ret[0].(*model.ErrorPost)
	return ret0
}
...
func (m *MockPostRepository) DeletePost(id uint) *model.ErrorPost {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPostById(id uint) (model.Post, *model.ErrorPost) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPostById", id)
	ret0, _ := ret[0].(model.Post)
	ret1, _ := ret[1].(*model.ErrorPost)
	return ret0, ret1
}
...
func (m *MockPostRepository) GetPosts() ([]model.Post, *model.ErrorPost) {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPostsByAuthorId(authorId uint) ([]model.Post, *model.ErrorPost) {
	m.ctrl.T.Helper()
