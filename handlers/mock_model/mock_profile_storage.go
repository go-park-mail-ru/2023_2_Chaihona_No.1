...
func (m *MockProfileRepository) DeleteProfile(id uint) error {
	m.ctrl.T.Helper()
...
func (mr *MockProfileRepositoryMockRecorder) DeleteProfile(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteProfile", reflect.TypeOf((*MockProfileRepository)(nil).DeleteProfile), id)
}
