...
var file_posts_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x79, 0x32, 0xab, 0x05, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x53, 0x65, 0x72,
	...
	0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x62, 0x06, 0x70,
...
var file_posts_proto_depIdxs = []int32{
	...
	9,  // 21: posts.PostsService.CreateNewPostCtx:output_type -> posts.Int
	11, // 22: posts.PostsService.DeletePostCtx:output_type -> posts.Nothing
	11, // 23: posts.PostsService.ChangePostCtx:output_type -> posts.Nothing
	6,  // 24: posts.PostsService.GetPostByIdCtx:output_type -> posts.PostGRPC
	7,  // 25: posts.PostsService.GetPostsByAuthorIdForStrangerCtx:output_type -> posts.PostsMapGRPC
	7,  // 26: posts.PostsService.GetOwnPostsByAuthorIdCtx:output_type -> posts.PostsMapGRPC
	7,  // 27: posts.PostsService.GetPostsByAuthorIdForFollowerCtx:output_type -> posts.PostsMapGRPC
	7,  // 28: posts.PostsService.GetUsersFeedCtx:output_type -> posts.PostsMapGRPC
	9,  // 29: posts.PostsService.CreateCommentCtx:output_type -> posts.Int
	11, // 30: posts.PostsService.DeleteCommentCtx:output_type -> posts.Nothing
	11, // 31: posts.PostsService.ChangeCommentCtx:output_type -> posts.Nothing
