...
type CommentGRPC struct {
	...
	Id           uint32    `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	User         *UserGRPC `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`
...
func (x *CommentGRPC) GetUser() *UserGRPC {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *CommentGRPC) GetCreationDate() string {
	if x != nil {
...
var file_posts_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7b, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x47,
	0x52, 0x50, 0x43, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78,
	...
	0x74, 0x65, 0x22, 0xab, 0x01, 0x0a, 0x0c, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x47,
	0x52, 0x50, 0x43, 0x12, 0x47, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x5f,
	0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x6f, 0x73, 0x74,
	...
	0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x4d, 0x61, 0x70, 0x1a, 0x52, 0x0a, 0x10,
	...
	0x0b, 0x32, 0x12, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x47, 0x52, 0x50, 0x43, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01,
	...
	0x08, 0x52, 0x05, 0x64, 0x75, 0x6d, 0x6d, 0x79, 0x32, 0x88, 0x04, 0x0a, 0x0c, 0x50, 0x6f, 0x73,
	...
	0x43, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x62,
...
var file_posts_proto_depIdxs = []int32{
	...
	4,  // 1: posts.CommentGRPC.user:type_name -> posts.UserGRPC
	12, // 2: posts.CommentsGRPC.comments_map:type_name -> posts.CommentsGRPC.CommentsMapEntry
	3,  // 3: posts.PostGRPC.comments:type_name -> posts.CommentsGRPC
	1,  // 4: posts.PostGRPC.tags:type_name -> posts.TagsGRPC
	13, // 5: posts.PostsMapGRPC.posts:type_name -> posts.PostsMapGRPC.PostsEntry
	...
	5,  // 8: posts.PostsMapGRPC.PostsEntry.value:type_name -> posts.PostGRPC
	5,  // 9: posts.PostsService.CreateNewPostCtx:input_type -> posts.PostGRPC
	7,  // 10: posts.PostsService.DeletePostCtx:input_type -> posts.UInt
	5,  // 11: posts.PostsService.ChangePostCtx:input_type -> posts.PostGRPC
	7,  // 12: posts.PostsService.GetPostByIdCtx:input_type -> posts.UInt
	9,  // 13: posts.PostsService.GetPostsByAuthorIdForStrangerCtx:input_type -> posts.AuthorSubscriberId
	9,  // 14: posts.PostsService.GetOwnPostsByAuthorIdCtx:input_type -> posts.AuthorSubscriberId
	9,  // 15: posts.PostsService.GetPostsByAuthorIdForFollowerCtx:input_type -> posts.AuthorSubscriberId
	7,  // 16: posts.PostsService.GetUsersFeedCtx:input_type -> posts.UInt
	8,  // 17: posts.PostsService.CreateNewPostCtx:output_type -> posts.Int
	10, // 18: posts.PostsService.DeletePostCtx:output_type -> posts.Nothing
	10, // 19: posts.PostsService.ChangePostCtx:output_type -> posts.Nothing
	5,  // 20: posts.PostsService.GetPostByIdCtx:output_type -> posts.PostGRPC
	6,  // 21: posts.PostsService.GetPostsByAuthorIdForStrangerCtx:output_type -> posts.PostsMapGRPC
	6,  // 22: posts.PostsService.GetOwnPostsByAuthorIdCtx:output_type -> posts.PostsMapGRPC
	6,  // 23: posts.PostsService.GetPostsByAuthorIdForFollowerCtx:output_type -> posts.PostsMapGRPC
	6,  // 24: posts.PostsService.GetUsersFeedCtx:output_type -> posts.PostsMapGRPC
