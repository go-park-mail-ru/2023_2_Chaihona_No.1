...
// Source: model/post_repository.go
...
func (m *MockPostRepository) CreateNewPost(post model.Post) *posts.ErrorPost {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateNewPost", post)
	ret0, _ := ret[0].(*posts.ErrorPost)
	return ret0
}
...
func (m *MockPostRepository) DeletePost(id uint) *posts.ErrorPost {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPostById(id uint) (model.Post, *posts.ErrorPost) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPostById", id)
	ret0, _ := ret[0].(model.Post)
	ret1, _ := ret[1].(*posts.ErrorPost)
	return ret0, ret1
}
...
func (m *MockPostRepository) GetPosts() ([]model.Post, *posts.ErrorPost) {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPostsByAuthorId(authorId uint) ([]model.Post, *posts.ErrorPost) {
	m.ctrl.T.Helper()
