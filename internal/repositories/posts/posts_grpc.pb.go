...
const (
	...
	PostsService_CreateCommentCtx_FullMethodName                 = "/posts.PostsService/CreateCommentCtx"
	PostsService_DeleteCommentCtx_FullMethodName                 = "/posts.PostsService/DeleteCommentCtx"
	PostsService_ChangeCommentCtx_FullMethodName                 = "/posts.PostsService/ChangeCommentCtx"
	PostsService_GetPostsByTagCtx_FullMethodName                 = "/posts.PostsService/GetPostsByTagCtx"
)
...
type PostsServiceClient interface {
	...
	GetPostsByTagCtx(ctx context.Context, in *TagGRPC, opts ...grpc.CallOption) (*PostsMapGRPC, error)
}
...
func (c *postsServiceClient) CreateCommentCtx(ctx context.Context, in *CommentGRPC, opts ...grpc.CallOption) (*Int, error) {
	out := new(Int)
	err := c.cc.Invoke(ctx, PostsService_CreateCommentCtx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *postsServiceClient) DeleteCommentCtx(ctx context.Context, in *UInt, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, PostsService_DeleteCommentCtx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *postsServiceClient) ChangeCommentCtx(ctx context.Context, in *CommentGRPC, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, PostsService_ChangeCommentCtx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *postsServiceClient) GetPostsByTagCtx(ctx context.Context, in *TagGRPC, opts ...grpc.CallOption) (*PostsMapGRPC, error) {
	out := new(PostsMapGRPC)
	err := c.cc.Invoke(ctx, PostsService_GetPostsByTagCtx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostsServiceServer interface {
	...
	GetPostsByTagCtx(context.Context, *TagGRPC) (*PostsMapGRPC, error)
...
func (UnimplementedPostsServiceServer) GetPostsByTagCtx(context.Context, *TagGRPC) (*PostsMapGRPC, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPostsByTagCtx not implemented")
}
...
func _PostsService_CreateCommentCtx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostsService_CreateCommentCtx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PostsService_DeleteCommentCtx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostsService_DeleteCommentCtx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PostsService_ChangeCommentCtx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostsService_ChangeCommentCtx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PostsService_GetPostsByTagCtx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TagGRPC)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostsServiceServer).GetPostsByTagCtx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostsService_GetPostsByTagCtx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostsServiceServer).GetPostsByTagCtx(ctx, req.(*TagGRPC))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPostsByTagCtx",
			Handler:    _PostsService_GetPostsByTagCtx_Handler,
		},
	},
